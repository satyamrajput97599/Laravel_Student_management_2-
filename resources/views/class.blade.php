...
/* Adjust height of form elements */
.form-select,
.form-control {
    height: 40px; /* Set height for form elements */
}
                        ...
                        <div class="card-body">
                          ...
                          <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                              ...
                              <tr>
                                  <td>{{$row['id']}}</td>
                                  <td><b>{{$row['course']}}</b><b>{{$row['level']}}</b><b>{{$row['section']}}</b></td>
                                  <td class="text-center">

                                      <a href="/editclass?editid={{$row['id']}}" class="btn btn-sm btn-outline-primary edit_course" type="button">Edit</a>

                                      <a href="/deleteclass?delid={{$row['id']}}" type="button" class="btn btn-danger"><span class="glyphicon glyphicon-ok-sign"></span>Delete</a>
                                  </td>
                              </tr>
                              @endforeach
                          </tbody>
