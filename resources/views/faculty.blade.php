...
<head>
    ...
    <style>
        ...
        */
        ...
        /* Decrease width of other columns */
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <form>
                                                ...
                                                Address
                                                <textarea name="a" id="" cols="30" rows="4" class="form-control"></textarea>
                                  ...
                                  @foreach ($data as $row)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="/editfaculty?editid={{$row['id']}}" class="btn btn-sm btn-outline-primary edit_course" type="button">Edit</a>

                                            <a href="/deletefaculty?delid={{$row['id']}}" type="button" class="btn btn-success"><span class="glyphicon glyphicon-ok-sign"></span> Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
